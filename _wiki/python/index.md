...
To work with ```python```, it is best to [install ```mamba```](https://mamba.readthedocs.io/en/latest/installation/mamba-installation.html) and then use it to create a new environment, within which you can install various libraries as you need them.
