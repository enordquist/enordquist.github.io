...
description: "a super useful set of shortcuts"
permalink: /wiki/bash/keybindings/
pinned: true
order: 8
---

On most shells, including bash, there is a set of incredibly simple and powerful keyboard shortcuts that you should learn and get comfortable using. I've copied this cheatsheet from [here](https://gist.github.com/tuxfight3r/60051ac67c5f0445efee):
