...
1. ```nano```: an intuitive editor integrated in the shell

### Higher productivity:
1. ```vi```: My editor of choice, see [here](vi)
1. ```Visual Studio Code```: Popular GUI editor/IDE developed by Microsoft
